class VotesController < ApplicationController
  ...
  def get_vote
    ...
    if token_from_params
      ...
      render json: {status: "success", action: "get_vote", helpful_votes: num_helpful, current_user_voted: current_user_voted}, status: 200
    else
      ...
      render json: {status: "success", action: "get_vote", helpful_votes: num_helpful, current_user_voted: false }, status: 200
    end
